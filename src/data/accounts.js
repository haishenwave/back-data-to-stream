  ...
  // ─── 账号 2：精品茶具 ───────────────────────────────────────────────
  {
    ...
    homeData: {
      stats: [
        ...
        { title: '本月成交订单', value: '1,506', trend: -23.0 },
        { title: '本月场均客单价', value: '78.84美元', trend: 8.5 },
        { title: '本月新增高活粉丝', value: '2,150', trend: 35.2 },
      ],
      liveRecords: [
        { id: 1, title: '3月16日直播数据复盘', date: '2026-03-16 18:00', gmv: '241,300', orders: '451', status: '已归档' },
    ...
    dashboardData: {
      ...
      topMetrics: {
        row1: [
          ...
          { title: '本场交易件数',       value: '451',    unit: '件',   sub: '同比涨幅 +6.4%',  desc: '本场直播成功售出的商品总件数。' },
          { title: '成交转化率',         value: '6.3',    unit: '%',    sub: '广泛引流拉新',    desc: '成交人数 / 独立访客数。反映本次直播流量的精准度与购买意愿。' },
          { title: '平均客单价',         value: '78.84',  unit: '美元', sub: '客均消费水平',    desc: '平均每笔成交订单的金额（美元）。' },
        ],
        row2: [
          ...
          { title: '千次观看成交', value: '73',    unit: '美元', sub: '商业变现效率',    desc: 'GPM：平均每1000次观看带来的成交金额。' },
        ],
        row3: [
          { title: '商业广告消耗', value: '0',    unit: '美元', sub: '全自然/私域流量', desc: '本场直播投放商业化工具的累计消耗金额。' },
      ...
      bottomChart: {
        ...
        orders: [19, 51, 78, 93, 72, 60, 40, 22, 16],
      },
      ...
      productRanking: [
        { name: '汝窑功夫茶具12件套', sales: '149', amount: '$14,900' },
        { name: '汝窑盖碗三件套',     sales: '163', amount: '$13,040' },
        { name: '汝窑品茗杯单杯',     sales: '139', amount: '$7,645'  },
      ],
    },
  },
]
